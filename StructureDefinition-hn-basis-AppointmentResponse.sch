...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile NoBasisAppointmentResponse
  ...
  <sch:pattern>
    <sch:title>f:AppointmentResponse/f:identifier</sch:title>
    <sch:rule context="f:AppointmentResponse/f:identifier">
  ...
  <sch:pattern>
    <sch:title>f:AppointmentResponse/f:appointment</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:AppointmentResponse/f:participantType</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:AppointmentResponse/f:actor/f:identifier</sch:title>
    <sch:rule context="f:AppointmentResponse/f:actor/f:identifier">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:use) &lt;= 1">use: maximum cardinality of 'use' is 1</sch:assert>
      <sch:assert test="count(f:type) &gt;= 1">type: minimum cardinality of 'type' is 1</sch:assert>
      <sch:assert test="count(f:type) &lt;= 1">type: maximum cardinality of 'type' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:AppointmentResponse/f:actor/f:identifier/f:type</sch:title>
    <sch:rule context="f:AppointmentResponse/f:actor/f:identifier/f:type">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:AppointmentResponse/f:actor/f:identifier/f:type/f:coding</sch:title>
    <sch:rule context="f:AppointmentResponse/f:actor/f:identifier/f:type/f:coding">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
      <sch:assert test="count(f:system) &gt;= 1">system: minimum cardinality of 'system' is 1</sch:assert>
      <sch:assert test="count(f:system) &lt;= 1">system: maximum cardinality of 'system' is 1</sch:assert>
