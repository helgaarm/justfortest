...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>f:Flag/f:identifier</sch:title>
    <sch:rule context="f:Flag/f:identifier">
  ...
  <sch:pattern>
    <sch:title>f:Flag/f:status/f:extension</sch:title>
    <sch:rule context="f:Flag/f:status/f:extension">
      <sch:assert test="count(f:id) &lt;= 1">id: maximum cardinality of 'id' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Flag/f:category</sch:title>
  ...
  <sch:pattern>
    <sch:title>f:Flag/f:code</sch:title>
